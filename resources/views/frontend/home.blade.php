...
<head>
    ...
    <title>Guest Rent Service Management</title>
...
<div class="body-wrapper">    
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="index.html"><img src="frontend/img/logo-2.png" alt="Logo"></a>
                            </div>
                            ...
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="service.html">Service</a></li>



                                         <li class="menu-icon"><a href="room.html">Rooms</a>
    ...
    <div class="ltn__slider-area ltn__slider-4">
        <div class="ltn__slide-one-active----- slick-slide-arrow-1----- slick-slide-dots-1----- arrow-white----- ltn__slide-animation-active">
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-4 bg-image bg-overlay-theme-black-60" data-bs-bg="frontend/img/slider/11.jpg">
                                            ...
                                            <div class="tab-pane fade active show" id="ltn__form_tab_1_1">
                                                <div class="car-dealer-form-inner">
                                                    <form action="#" class="ltn__car-dealer-form-box row">
                                                        ...
                                                        <div class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-cog col-lg-4 col-md-6">                                                            
                                                            <div class="input-item input-item-name ltn__custom-icon">
                                                                <input type="text" name="name" placeholder="check Out">
                                                            </div>
                                                        </div> 
                                                        <div class="car-price-filter-range col-lg-12">
                                                            ...
                                                            <div class="btn-wrapper text-center">
                                                                ...
                                                                <a href="room.html" class="btn theme-btn-1 btn-effect-1 text-uppercase">Search Home</a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
        ...
        <div class="container">
            ...
            <div class="row ltn__product-slider-item-three-active--- slick-arrow-1">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="#"><img src="frontend/img/product-3/1.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="#"><img src="frontend/img/blog/author.jpg" alt="#"></a>
                                </div>
                            </div>
                        </div>
                        <div class="product-info">
                            ...
                            <div class="product-img-location">
                                <ul>
                                    <li>
                                        <a href="#"><i class="flaticon-pin"></i> Dhaka, Gulshan</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="product-info-bottom">
                            <div class="product-price">
                                <span>400BDT<label>/Day</label></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="#"><img src="frontend/img/product-3/2.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="#"><img src="frontend/img/blog/author.jpg" alt="#"></a>
                                </div>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-img-location">
                                <ul>
                                    <li>
                                        <a href="#"><i class="flaticon-pin"></i> Banani, Dhaka</a>
                                    </li>
                                </ul>
                            </div>
                            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                        ...
                        <div class="product-info-bottom">
                            <div class="product-price">
                                <span>300BDT<label>/Day</label></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-img-location">
                                <ul>
                                    <li>
                                        <a href="#"><i class="flaticon-pin"></i> Dhanmondi, Dhaka </a>
                                    </li>
                                </ul>
                            </div>
                            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                        ...
                        <div class="product-info-bottom">
                            <div class="product-price">
                                <span>250BDT<label>/Day</label></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="#"><img src="frontend/img/product-3/4.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="#"><img src="frontend/img/blog/author.jpg" alt="#"></a>
                                </div>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-img-location">
                                <ul>
                                    <li>
                                        <a href="#"><i class="flaticon-pin"></i> Kalabagan, Dhaka</a>
                                    </li>
                                </ul>
                            </div>
                            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="#"><img src="frontend/img/product-3/5.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="#"><img src="frontend/img/blog/author.jpg" alt="#"></a>
                                </div>
                        ...
                        <div class="product-info-bottom">
                            <div class="product-price">
                                <span>390BDT<label>/Day</label></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="#"><img src="frontend/img/product-3/6.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="#"><img src="frontend/img/blog/author.jpg" alt="#"></a>
                                </div>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-img-location">
                                <ul>
                                    <li>
                                        <a href="#"><i class="flaticon-pin"></i> Gulshan, Dhaka</a>
                                    </li>
                                </ul>
                            </div>
                            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                        ...
                        <div class="product-info-bottom">
                            <div class="product-price">
                                <span>900BDT<label>/Day</label></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="ltn__video-popup-area ltn__video-popup-margin---">
        <div class="ltn__video-bg-img ltn__video-popup-height-600--- bg-overlay-black-30 bg-image bg-fixed ltn__animation-pulse1" data-bs-bg="frontend/img/bg/19.jpg">
    ...
    <!-- CATEGORY AREA START -->
    <div class="ltn__category-area section-bg-1-- ltn__primary-bg before-bg-1 bg-image bg-overlay-theme-black-5--0 pt-115 pb-90 d-none" data-bs-bg="frontend/img/bg/5.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
    ...
    <div class="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-70" data-bs-bg="frontend/img/bg/20.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="frontend/img/product/4.png" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="frontend/img/product/1.png" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="frontend/img/product/7.png" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                            <h5><a href="product-details.html">3 Rooms Manhattan</a></h5>
